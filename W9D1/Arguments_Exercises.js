...
function sum(...moreNums) {
    return moreNums.reduce((acc, el) => acc + el)
}

// why do brackets make ^^^ undefined??
// sum(1, 2, 3, 4) === 10;
// sum(1, 2, 3, 4, 5) === 15;

// console.log(sum(1, 2, 3, 4,-2, 5));
...
Function.prototype.myBind = function() {
    ...
    // console.log(args);
    const bindTimeArgs = args.slice(1);
    // console.log(params);

    return function() {
        const callTimeArgs = Array.prototype.slice.call(arguments);
        
        instance.apply(context, bindTimeArgs.concat(callTimeArgs));
    }
}
...
console.log(suma(5)(30)(20)(1)(100)); // => 56
